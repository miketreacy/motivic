<section id="randomizer" class="show closed form">
        <details data-section="randomizer">
            <summary>
                <h2><span class="icons dice">&#9861;</span>Randomizer<span class="icons dice">&#9861;</span></h2>
                <p class="info">generates a random monophonic melody based on user settings</p>
            </summary>
        ...
        <div class="form-controls">
            <button class="section-toggle" data-section="randomizer">open</button>
            <button class="reset" data-section="randomizer" disabled>reset</button>
            <button class="apply randomize" id="randomize" data-section="randomizer">
                <span>apply</span>
            </button>
        </div>
    </section>